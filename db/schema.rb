...
ActiveRecord::Schema.define(version: 20180806104127) do
  ...
  create_table "spree_bulk_store_credit_updaters", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
